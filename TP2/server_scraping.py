...
# Inicia y termina el proceso de scrapping
...
# Ejecuta las tareas de scrapping
...
# Se comunica con el servidor de procesamiento para enviarle la URL sobre la que realizar las tareas
